...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d4 = new Department { Id = 4, Name = "Books" }; //pode ser assim também

            Seller s1 = new Seller(1 , "Bob brown" , "bob@gmail.com", new DateTime(1998, 4,21), 1000.0, d1);
            Seller s2 = new Seller(2 , "Maria Green" , "maria@gmail.com", new DateTime(1979, 12,31), 2000.0, d2);
            Seller s3 = new Seller(3 , "Alex Grey" , "alex@gmail.com", new DateTime(1988, 1,15), 22000.0, d3);
            Seller s4 = new Seller(4 , "Martha Red" , "red@gmail.com", new DateTime(1993, 11,22), 8000.0, d4);
            Seller s5 = new Seller(5 , "Donald Blue" , "donald@gmail.com", new DateTime(1998, 4,21), 1000.0, d1);
